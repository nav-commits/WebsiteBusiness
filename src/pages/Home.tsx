  ...
  <div className="max-w-6xl mx-auto px-6 sm:px-12 lg:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
    <div className="text-left">
      ...
      <p className="text-lg text-gray-600 mb-6">
        Hi, I'm Nav Dhamrait, a passionate Web Developer & Designer dedicated to helping businesses build their online presence. I create modern, high-performing websites that are easy to use and designed to convert visitors into customers.
      </p>
      <p className="text-lg text-gray-600 mb-6">
