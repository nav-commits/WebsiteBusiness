          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
              ...
              <div className="p-6 flex-grow">
                ...
                <p className="text-gray-600">
                  A dedicated real estate law firm offering expert legal
                  guidance across Ontario. PSR Law is committed to transparency,
                  integrity, and client-focused service—supporting first-time
                  buyers and seasoned investors with professional legal care.
                </p>
              </div>
              <div className="p-6">
                <Link
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
              ...
              <div className="p-6 flex-grow">
                ...
                <p className="text-gray-600">
                  A leading storage terminal in the GTA, offering secure, 24/7
                  monitored container and trailer storage. With a client-first
                  approach and strategic location in Brampton, they provide
                  flexible, safe, and professional service for the freight and
                  trucking industry.
                </p>
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
              <img
                src="/vik.jpg" // Replace with your actual image path
                alt="Our Philosophy"
                className="w-full h-48 object-cover"
              />
              <div className="p-6 flex-grow">
                ...
                <div className="text-gray-700 text-base space-y-4">
                  <p>
                    Based in the Tri-Cities and serving the Lower Mainland, our
                    Family Law firm specializes in providing personal,
                    lawyer-to-client communication—because{" "}
                    <strong>
                      if you hire a lawyer, you should be attended to by a
                      lawyer.
                    </strong>
                  </p>
                </div>
